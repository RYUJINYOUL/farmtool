...
export default function NaraWishList({ onClose }) { // initialNaraWishListDetails, initialNaraCount props 제거
  ...
  const fetchNaraWishListDetails = useCallback(async (isInitialLoad = true) => {
    ...
    try {
      ...
      const naraCollectionRef = collection(userDocRef, "nara");
