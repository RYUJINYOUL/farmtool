...
const EditUpload2 = ({ isOpen, col, id, onClose }) => {
  ...
  const [formState, setFormState] = useState({
    ...
    TopCategories: '전체',
    SubCategories: ['전체'],
    materials_businessLicense: '', 
    materials_materialType: '',             
    materials_name: '',          
    materials_companyPhoneNumber: ''                 
  });
    ...
    const fetchPostData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormState({
            materials_businessLicense: data.materials_businessLicense,    //사업자등록번호
            materials_materialType: data.materials_materialType,  //주요자재
            materials_name: data.materials_name || '',
            materials_companyPhoneNumber: data.materials_companyPhoneNumber,
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formState.materials_name || !formState.TopCategories || !formState.address) {
        ...
        <Dialog.Panel className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl w-full max-w-[600px] flex flex-col max-h-[90vh] relative">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {subShowRegionList && (
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="materials_name" className="text-right">회사명</Label>
                <Input id="materials_name" value={formState.materials_name} onChange={handleInputChange} className="col-span-3" />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="materials_businessLicense" className="text-right">사업자등록번호</Label>
                <Input id="materials_businessLicense" value={formState.materials_businessLicense} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="materials_companyPhoneNumber" className="text-right">전화번호</Label>
                <Input id="materials_companyPhoneNumber" value={formState.materials_companyPhoneNumber} onChange={handleInputChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="materials_materialType" className="text-right">주요자재</Label>
                <textarea id="materials_materialType" value={formState.materials_materialType} onChange={handleInputChange} className="col-span-3 border rounded p-2 min-h-[60px] resize-y" required />
              </div>
