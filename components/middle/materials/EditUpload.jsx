...
const EditUpload = ({ isOpen, col, id, onClose }) => {
    ...
    const fetchPostData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormState({
            matApply_description: data.matApply_description, 
            matApply_materialType: data.matApply_materialType,             
            matApply_name: data.matApply_name,          
            matApply_phoneNumber: data.matApply_phoneNumber,
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formState.matApply_name || !formState.TopCategories || !formState.address) {
        ...
        <Dialog.Panel className="bg-white p-6 rounded-lg shadow-xl w-full max-w-[600px] flex flex-col max-h-[90vh] relative">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {subShowRegionList && (
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="matApply_name" className="text-right">이름</Label>
                <Input id="matApply_name" value={formState.matApply_name} onChange={handleInputChange} className="col-span-3" />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="matApply_description" className="text-right">상세 내용</Label>
                <textarea id="matApply_description" value={formState.matApply_description} onChange={handleInputChange} className="col-span-3 border rounded p-2 min-h-[60px] resize-y" required />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="matApply_phoneNumber" className="text-right">연락처</Label>
                <Input id="matApply_phoneNumber" value={formState.matApply_phoneNumber} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="matApply_materialType" className="text-right">필요자재</Label>
                <Input id="matApply_materialType" value={formState.matApply_materialType} onChange={handleInputChange} className="col-span-3" />
              </div>
