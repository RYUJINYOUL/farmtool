...
const EditUpload2 = ({ isOpen, col, id, onClose }) => {
  ...
  const [formState, setFormState] = useState({
    ...
    TopCategories: '전체',
    SubCategories: ['전체'],
    construction_businessLicense: '', 
    construction_constructionExperience: '',             
    construction_phoneNumber: '',          
    construction_name: '',
    construction_contactPerson: ''              
  });
    ...
    const fetchPostData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormState({
            construction_name: data.construction_name || data.construction_companyName || '',
            construction_businessLicense: data.construction_businessLicense || '',
            construction_constructionExperience: data.construction_constructionExperience || '',
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formState.construction_name || !formState.TopCategories || !formState.address) {
        ...
        <Dialog.Panel className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl w-full max-w-[600px] flex flex-col max-h-[90vh] relative">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {subShowRegionList && (
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="construction_name" className="text-right">회사명</Label>
                <Input id="construction_name" value={formState.construction_name} onChange={handleInputChange} className="col-span-3" />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="construction_contactPerson" className="text-right">대표자</Label>
                <Input id="construction_contactPerson" value={formState.construction_contactPerson} onChange={handleInputChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="construction_businessLicense" className="text-right">사업자등록번호</Label>
                <Input id="construction_businessLicense" value={formState.construction_businessLicense} onChange={handleInputChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="construction_phoneNumber" className="text-right">전화번호</Label>
                <Input id="construction_phoneNumber" value={formState.construction_phoneNumber} onChange={handleInputChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="construction_constructionExperience" className="text-right">연혁</Label>
                <textarea id="construction_constructionExperience" value={formState.construction_constructionExperience} onChange={handleInputChange} className="col-span-3 border rounded p-2 min-h-[60px] resize-y" required />
              </div>
