        ...
        <Dialog.Panel className="bg-white p-6 rounded-lg shadow-xl w-full max-w-[600px] flex flex-col max-h-[90vh] relative">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {subShowRegionList && (
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="conApply_name" className="text-right">이름</Label>
                <Input id="conApply_name" value={formState.conApply_name} onChange={handleInputChange} className="col-span-3" />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <textarea id="conApply_description" value={formState.conApply_description} onChange={handleInputChange} className="col-span-3 border rounded p-2 min-h-[60px] resize-y" required />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="conApply_phoneNumber" className="text-right">연락처</Label>
                <Input id="conApply_phoneNumber" value={formState.conApply_phoneNumber} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="conApply_constructionExperience" className="text-right">경력사항</Label>
                <Input id="conApply_constructionExperience" value={formState.conApply_constructionExperience} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="conApply_documents" className="text-right">필요서류</Label>
                <Input id="conApply_documents" value={formState.conApply_documents} onChange={handleInputChange} className="col-span-3" />
              </div>
