...
const EditUpload = ({ isOpen, col, id, onClose }) => {
  ...
  const [formState, setFormState] = useState({
    ...
    TopCategories: '전체',
    SubCategories: ['전체'],
    equipApply_description: '', 
    equipApply_career: '',             
    equipApply_name: '',          
    equipApply_rental: '',  
    equipApply_phoneNumber: '',
    equipApply_rentalRates: ''              
  });
    ...
    const fetchPostData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormState({
            equipApply_description: data.equipApply_description, 
            equipApply_career: data.equipApply_career,             
            equipApply_name: data.equipApply_name,          
            equipApply_rental: data.equipApply_rental,  
            equipApply_phoneNumber: data.equipApply_phoneNumber,
            equipApply_rentalRates: data.equipApply_rentalRates,             
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formState.equipApply_name || !formState.TopCategories || !formState.address) {
        ...
        <Dialog.Panel className="bg-white p-6 rounded-lg shadow-xl w-full max-w-[600px] flex flex-col max-h-[90vh] relative">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {subShowRegionList && (
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="equipApply_name" className="text-right">이름</Label>
                <Input id="equipApply_name" value={formState.equipApply_name} onChange={handleInputChange} className="col-span-3" />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="equipApply_description" className="text-right">상세 내용</Label>
                <textarea id="equipApply_description" value={formState.equipApply_description} onChange={handleInputChange} className="col-span-3 border rounded p-2 min-h-[60px] resize-y" required />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="equipApply_phoneNumber" className="text-right">연락처</Label>
                <Input id="equipApply_phoneNumber" value={formState.equipApply_phoneNumber} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="equipApply_career" className="text-right">경력사항</Label>
                <Input id="equipApply_career" value={formState.equipApply_career} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="equipApply_rental" className="text-right">운전원필요여부</Label>
                <Input id="equipApply_rental" value={formState.equipApply_rental} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="equipApply_rentalRates" className="text-right">장비이용료</Label>
                <Input id="equipApply_rentalRates" value={formState.equipApply_rentalRates} onChange={handleInputChange} className="col-span-3" />
              </div>
