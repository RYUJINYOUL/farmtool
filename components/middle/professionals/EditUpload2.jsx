...
const EditUpload2 = ({ isOpen, col, id, onClose }) => {
  ...
  const [formState, setFormState] = useState({
    ...
    professionals_career: '',             
    professionals_name: '',          
    professionals_phoneNumber: ''                 
  });
    ...
    const fetchPostData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormState({
            professionals_certificate: data.professionals_certificate,    //자격증
            professionals_career: data.professionals_career,  //경력
            professionals_name: data.professionals_name || '',
            professionals_phoneNumber: data.professionals_phoneNumber,
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formState.professionals_name || !formState.TopCategories || !formState.address) {
        ...
        <Dialog.Panel className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl w-full max-w-[600px] flex flex-col max-h-[90vh] relative">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {subShowRegionList && (
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="professionals_name" className="text-right">성명</Label>
                <Input id="professionals_name" value={formState.professionals_name} onChange={handleInputChange} className="col-span-3" />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="professionals_certificate" className="text-right">자격증</Label>
                <Input id="professionals_certificate" value={formState.professionals_certificate} onChange={handleInputChange} className="col-span-3" />
              </div>

               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="professionals_phoneNumber" className="text-right">전화번호</Label>
                <Input id="professionals_phoneNumber" value={formState.professionals_phoneNumber} onChange={handleInputChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="professionals_career" className="text-right">경력사항</Label>
                <textarea id="professionals_career" value={formState.professionals_career} onChange={handleInputChange} className="col-span-3 border rounded p-2 min-h-[60px] resize-y" required />
              </div>
