...
const EditUpload = ({ isOpen, col, id, onClose }) => {
    ...
    const fetchPostData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormState({
            proApply_description: data.proApply_description,    //설명
            proApply_name: data.proApply_name || '',
            proApply_phoneNumber: data.proApply_phoneNumber,
            proApply_certificate: data.proApply_certificate,
            proApply_career: data.proApply_career,
            proApply_rates: data.proApply_rates,
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formState.proApply_name || !formState.TopCategories || !formState.address) {
        ...
        <Dialog.Panel className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl w-full max-w-[600px] flex flex-col max-h-[90vh] relative">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {subShowRegionList && (
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="proApply_name" className="text-right">이름</Label>
                <Input id="proApply_name" value={formState.proApply_name} onChange={handleInputChange} className="col-span-3" />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="proApply_description" className="text-right">상세 내용</Label>
                <textarea id="proApply_description" value={formState.proApply_description} onChange={handleInputChange} className="col-span-3 border rounded p-2 min-h-[60px] resize-y" required />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="proApply_phoneNumber" className="text-right">연락처</Label>
                <Input id="proApply_phoneNumber" value={formState.proApply_phoneNumber} onChange={handleInputChange} className="col-span-3" />
              </div>
               <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="proApply_certificate" className="text-right">자격증</Label>
                <Input id="proApply_certificate" value={formState.proApply_certificate} onChange={handleInputChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="proApply_career" className="text-right">경력사항</Label>
                <Input id="proApply_career" value={formState.proApply_career} onChange={handleInputChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="proApply_rates" className="text-right">일당</Label>
                <Input id="proApply_rates" value={formState.proApply_rates} onChange={handleInputChange} className="col-span-3" />
              </div>
