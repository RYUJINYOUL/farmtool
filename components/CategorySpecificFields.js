...
import { CATEGORY_SPECIFIC_FIELDS, KOREAN_TO_ENGLISH_CATEGORIES } from '@/lib/constants';
...
export default function CategorySpecificFields({
  ...
  const englishCategory = KOREAN_TO_ENGLISH_CATEGORIES[TopCategory];

  // 해당 영어 카테고리에 정의된 필드 목록을 가져옵니다.
  const fieldsToRender = CATEGORY_SPECIFIC_FIELDS[englishCategory] || [];
