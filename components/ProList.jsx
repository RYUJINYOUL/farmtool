    ...
    <div className='w-full h-full'>
      {messages.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {messages.map(({ address, businessLicense, phoneNumber, constructionExperience, contactPerson, createdDate, id, companyName, favorites, imageDownloadUrls}, idx) => ( // imageDownloadUrls 추가
            <div key={idx}
