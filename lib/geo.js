...
export async function get2 (addr){
    ...
    const data = await fetch("https://api.vworld.kr/req/search?key=592E9FA9-F45E-3CEF-8C97-499B33C882FE&request=search&type=ADDRESS&category=ROAD&query=주덕읍&size=2")
    const posts = await data.json()
