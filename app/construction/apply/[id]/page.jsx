            ...
            <div className={`space-y-8 ${message.imageDownloadUrls.length === 0 ? "" : "pt-6" }`}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50/50 rounded-xl p-6 space-y-1">
                  <dt className="text-sm font-medium text-gray-500">업력</dt>
                  <dd className="text-base text-gray-900">{message.constructionExperience || "-"}</dd>
                </div>
                
                <div className="bg-gray-50/50 rounded-xl p-6 space-y-1">
                  <dt className="text-sm font-medium text-gray-500">필요서류</dt>
                  <dd className="text-base text-gray-900">{message.document || "-"}</dd>
                </div>

                <div className="bg-gray-50/50 rounded-xl p-6 space-y-1">
                  <dt className="text-sm font-medium text-gray-500">해당업종</dt>
                ...
                <div className="bg-gray-50/50 rounded-xl p-6 space-y-1 md:col-span-2">
