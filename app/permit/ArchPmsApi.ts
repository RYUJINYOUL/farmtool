...
const ARCH_PMS_BASE_URL = 'https://apis.data.go.kr/1613000/ArchPmsHubService/getApBasisOulnInfo';
// 표준 행정구역 코드 API 기본 URL
const STAN_REGIN_CD_BASE_URL = 'https://apis.data.go.kr/1741000/StanReginCd/getStanReginCdList';
 ...
 */
export async function fetchLegalDongCodes(mainRegionName: string, subRegionName: string): Promise<{ data: LegalDongItem[], error: string | null }> {
  try {
