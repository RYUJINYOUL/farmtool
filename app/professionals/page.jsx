    ...
    <div className='relative md:top-10 top-10'>
      ...
      <div className="md:w-[1100px] w-full lg:mt-10 pt-3.5">
        ...
        <div className="flex md:flex-row flex-col gap-3 w-full">
          {/* 업종명 */}
          <div className="mb-1 flex-1 relative"> {/* Use flex-1 to make them take equal width within the flex container */}
            <button
              type="button"
            ...
            {showIndustryList && (
              <div className="mt-2 p-3 border border-gray-300 rounded-lg bg-white max-h-40 overflow-y-auto shadow-lg absolute z-10 w-full]"> {/* Added absolute positioning and specific width for dropdown */}
          ...
          {/* 지역 */}
          <div className="mb-1 flex-1 relative"> {/* Use flex-1 */}
            <button
              type="button"
