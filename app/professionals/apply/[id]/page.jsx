            ...
            <div className={`space-y-8 ${message.imageDownloadUrls.length === 0 ? "" : "pt-6" }`}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50/50 rounded-xl p-6 space-y-1">
                  ...
                  <dd className="text-base text-gray-900">{message.certificate || "-"}</dd>
                </div>

                <div className="bg-gray-50/50 rounded-xl p-6 space-y-1">
                  <dt className="text-sm font-medium text-gray-500">경력사항</dt>
                  <dd className="text-base text-gray-900">{message.career || "-"}</dd>
                </div>

                <div className="bg-gray-50/50 rounded-xl p-6 space-y-1">
                  <dt className="text-sm font-medium text-gray-500">일당</dt>
                  <dd className="text-base text-gray-900">{message.rates || "-"}</dd>
                </div>
