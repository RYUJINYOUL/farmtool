...
import Comment from '@/components/middle/professionals/comment';
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          const formattedMessage = {
            ...
            businessLicense: data.professionals_certificate,    //자격증
            constructionExperience: data.professionals_career,  //경력
            companyName: data.professionals_name || '',
            phoneNumber: data.professionals_phoneNumber,
  ...
  return (
    <div>
      <div className='lg:my-10 p-3.5 w-full'>
                ...
                <table className="min-w-full text-sm text-left text-gray-700 border border-gray-200 rounded-lg">
                  <tbody>
                    <tr className="border-b border-gray-200">
                      <th className="px-4 py-2 bg-gray-50 font-medium">자격증</th>
                      <td className="px-4 py-2">{message.businessLicense || '-'}</td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <th className="px-4 py-2 bg-gray-50 font-medium">전문전공</th>
        ...
        <Comment id={id} col="professionals" path={`/professionals/registration/${id}`} urls={message.imageDownloadUrls} />
