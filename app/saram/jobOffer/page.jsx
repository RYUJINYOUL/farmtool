  ...
  return (
    <div className='w-full h-full'>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <DialogContent className="sm:max-w-[600px] flex flex-col max-h-[90vh]"> {/* Added flex-col and max-h */}
          <DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="flex-grow overflow-y-auto pr-2"> {/* Added flex-grow and overflow-y-auto */}
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Dialog open={isAddrModalOpen} onOpenChange={setIsAddrModalOpen}>
                  <DialogContent>
                    {/* This inner dialog content likely also needs scrolling if addrList is long */}
                    <div className="max-h-[60vh] overflow-y-auto"> {/* Added max-h and overflow-y-auto */}
                      {isLocationLoading ? (
              ...
              {user?.uid === 'PkVnwSuEg1WE071zAZDgxuVr2ro1' || user?.uid === 'PkVnwSuEg1WE071zAZDgxuVr2ro1' && (
                <div className="grid grid-cols-4 items-center gap-4">
