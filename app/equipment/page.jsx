...
import ProList from "@/components/middle/equipment/ProList"
import ConOffer from "@/components/middle/equipment/ConOffer"
import { equipment, regions, hierarchicalRegions } from '@/lib/constants';
          ...
          <div className="md:w-[1100px] w-full lg:mt-10 pt-3.5">
            <Tabs value={pag} onValueChange={setPag} className="w-full">
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="account">건설장비</TabsTrigger>
