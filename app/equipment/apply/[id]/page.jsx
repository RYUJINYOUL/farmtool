            ...
            <div className={`overflow-x-auto ${message.imageDownloadUrls.length === 0 ? "" : "pt-10" }`}>
              <table className="min-w-full text-sm text-left text-gray-700 border border-gray-200 rounded-lg">
                <tbody>
                  ...
                  <tr className="border-b border-gray-200">
                    <th className="px-4 py-2 bg-gray-50 font-medium">장비이용료</th>
                    <td className="px-4 py-2">{message.rentalRates || "-"}</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="px-4 py-2 bg-gray-50 font-medium">필요장비</th>
                    <td className="px-4 py-2">
                      {(message.SubCategories || []).join(", ") || "-"}
                    </td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="px-4 py-2 bg-gray-50 font-medium">운전원필요여부</th>
